...
impl Engine {
	...
	///
	/// Test-only: integration tests use this to observe the effect of a watch
	/// action (e.g. that a synced file reached the container) and poll for it,
	/// instead of sleeping a fixed duration and assuming the action completed.

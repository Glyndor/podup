...
| Real-hardware smoke tests on macOS and Windows | Pending ([#48](https://github.com/Glyndor-net/podup/issues/48)); code paths exist but are untested on physical hardware |
